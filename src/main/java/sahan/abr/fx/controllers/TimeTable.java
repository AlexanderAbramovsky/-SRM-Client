...
public class TimeTable {
    ...
    public void outputLabelDayWeek() {
        ...
        if (date.getDay() == 1) dayOfWeek = "�����������";
        if (date.getDay() == 2) dayOfWeek = "�������";
        if (date.getDay() == 3) dayOfWeek = "�����";
        if (date.getDay() == 4) dayOfWeek = "�������";
        if (date.getDay() == 5) dayOfWeek = "�������";
        if (date.getDay() == 6) dayOfWeek = "�������";
        if (date.getDay() == 0) dayOfWeek = "�����������";
