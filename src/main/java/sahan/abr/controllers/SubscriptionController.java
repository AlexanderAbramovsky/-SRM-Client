...
import sahan.abr.controllers.Users.ModalUpdateSubscriptionController;
...
public class SubscriptionController {
    ...
    void addSubscription(ActionEvent event) {
        VistaNavigator.getModalWindow("SRM", VistaNavigator.MODAL_ADD_SUBSCRIPTION);
    }
                ...
                final TableCell<Subscription, Void> cell = new TableCell<Subscription, Void>() {
                    ...
                    private final HBox hBox = new HBox();
                    {
                        ...
                        buttonUpdate.setOnAction((ActionEvent event) -> {
                            ...
                            VistaNavigator.getModalWindow("SRM", VistaNavigator.MODAL_UPDATE_SUBSCRIPTION, controller);
                        });
